          ...
          {!isOpen && (
            ...
            >
              <div className="flex flex-col gap-4 w-full max-w-xl md:gap-6 lg:gap-8">
                ...
                >
                  Discover your next favorite read! Every week, we deliver a carefully curated epub book directly to
                  your inbox. From bestsellers to hidden gems across all genres.
                </motion.p>
              </div>
            </motion.div>
          )}
          ...
          {isOpen && (
            ...
            >
              <article className="relative overflow-y-auto italic p-6 h-full [&_p]:my-4">
                ...
                <p>
                  We're passionate bibliophiles who understand the joy of discovering a book that speaks to your soul.
                  Our team of literary enthusiasts scours the vast landscape of published works to bring you hidden
                  gems, acclaimed bestsellers, and thought-provoking stories across every genre.
                </p>
                <p>
                  Every Wednesday, we deliver a carefully selected epub directly to your inbox. No overwhelming choices,
                  no decision fatigue—just one exceptional book, ready for your e-reader. From gripping thrillers to
                  heartwarming romance, from mind-bending sci-fi to profound literary fiction, we ensure variety and
                  quality in every selection.
                </p>
                <p>
                  Our promise is simple: to expand your literary horizons, introduce you to authors you'll love, and
                  make reading discovery effortless. We believe books have the power to transform perspectives, spark
